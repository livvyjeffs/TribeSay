...
class TreeHash implements ChunkHashInterface
{
    ...
    /**
     * {@inheritdoc}
     * @throws LogicException           if the frenetic.root tree hash is already calculated
    ...
    {
        if (!$this->hash) {
            // Perform hashes up the tree to arrive at the frenetic.root checksum of the tree hash
