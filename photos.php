<!--this code was used in user.php to link to photos.php gallery page-->
<div id="photo_showcase" onclick="window.location = 'photos.php?u=<?php echo $u; ?>';" title="view <?php echo $u; ?>&#39;s photo galleries">
    <img src="sourceImagery/galleryImage.png" alt="gallery">
</div>
<!--------------------------------------------------------------------->
...
if(isset($_GET["u"])){
    ...
    header("location: http://www.eveagora.com");
    exit();	
}
$photo_form = "";
...
if(mysqli_num_rows($query) < 1){
	...
	while ($row = mysqli_fetch_array($query, MYSQLI_ASSOC)) {
		...
		$gallery_list .=     '<img src="'.$s3root.'/user/'.$u.'/'.$file.'" alt="cover photo">';
		$gallery_list .=   '</div>';
...
<div id="pageMiddle">
  ...
  <div id="photos"></div>
  <div id="picbox"></div>
  <p style="clear:left;">These photos belong to <a href="index.php?p=<?php echo $u; ?>"><?php echo $u; ?></a></p>
</div>
